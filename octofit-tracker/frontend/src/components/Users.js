  ...
  const loadData = () => {
    ...
    fetch(apiUrl)
      ...
      .then(data => {
        ...
        setUsers(Array.isArray(results) ? results : [results]);
      })
      .catch(err => {
    ...
    <div className="container py-3">
      <div className="card shadow-sm">
        ...
        <div className="card-body">
          ...
          <form className="mt-3">
            <div className="mb-3">
              <label htmlFor="userEmail" className="form-label">User email filter</label>
              <input id="userEmail" className="form-control" placeholder="UI only" readOnly />
            </div>
            <button className="btn btn-success btn-sm" type="button">Create User (UI demo)</button>
          </form>
        </div>
      </div>
          ...
          <div className="modal-dialog" role="document">
            <div className="modal-content">
              <div className="modal-header">
                <h5 className="modal-title">Users endpoint info</h5>
